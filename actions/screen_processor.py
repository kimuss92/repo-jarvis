...
import threading
import time
from core.utils import get_base_dir, load_config, get_api_key, get_os, log, BASE_DIR
...
_SYSTEM_PROMPT = (
    ...
    "Analyze only what is visible in the provided image. "
    "If something is unclear, say it is unclear instead of guessing. "
    "Be concise and direct — maximum two sentences unless the user's question requires more detail. "
    "Address the user respectfully. "
    "Never claim to see outside the captured screen/camera frame."
)
